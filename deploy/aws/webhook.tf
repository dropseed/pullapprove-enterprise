...
resource "aws_lambda_permission" "pullapprove_webhook_permission" {
  ...
  source_arn = "${aws_api_gateway_rest_api.pullapprove_gateway.execution_arn}/*/${aws_api_gateway_method.pullapprove_webhook_proxy_method.http_method}${aws_api_gateway_resource.pullapprove_webhook_proxy.path}"
}
